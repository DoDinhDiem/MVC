    ...
    $.get("/GioHang/LoadGioHang", function (data) {
        ...
        $.each(data.giohang, function (i, val) {
            $("#show-item-cart").append("<tr>"
                ...
                + "<a href='#'><img src='/Assets/images/" + val.Anh + "' alt='Product'></a>"
                + "</td>"
                + "<td class='product-name'><a href='#'>" + val.Ten + "</a>"
                + "</td>"
                ...
                + "<a class='minus' data-product-code='" + val.ID + "'><i class='fa fa-caret-up'></i></a>"
                + "<a class='plus' data-product-code='" + val.ID + "'><i class='fa fa-caret-down'></i></a>"
                + "</td>"
                + "<td class='price'>"
...
function displayCartPageCheckOut() {
    $.get("/GioHang/LoadGioHang", function (data) {
        $("#count-item-cart").html(data.soluong);
        $("#show-total_price").html(numberWithCommas(data.tongtien));
        $("#total_price_all").html(numberWithCommas(data.tongtien));
        $("#show-list-order").html("");
        $.each(data.giohang, function (i, val) {
            $("#show-list-order").append("<tr>"
                + "<td class='cart_product'>"
                + "<a href='#'><img src='/Assets/images/" + val.Anh + "' alt='Product'></a>"
                + "</td>"
                + "<td class='product-name'><a href='#'>" + val.Ten + "</a>"
